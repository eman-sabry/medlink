    ...
    <div className="p-6 space-y-8 max-w-7xl mx-auto" dir="rtl">
      ...
      <section className="space-y-4">
        ...
        <div className="bg-card border border-border rounded-3xl p-6 shadow-sm space-y-4">
          ...
          {currentSession ? (
            <DoctorSessionCard
              ...
              isStarting={startingAppointmentId === currentSession.id}
              isCompleting={completingAppointmentId === currentSession.id}
            />
          ) : (
            <EmptyState
        ...
        <div className="space-y-3">
          <h3 className="font-black text-foreground text-sm px-1">
            مرضى اليوم
          </h3>
